...
# 初始化Boruta特征选择器
if which == "sklearn":
    boruta_selector = boruta.BorutaPy(rfcv, n_estimators='auto', verbose=2, random_state=0, max_iter=100, perc = 50)
elif which == "score":
    boruta_selector = boruta_score.BorutaPy(rfcv, n_estimators='auto', verbose=2, random_state=0, max_iter=100, perc = 50)
elif which == "tree":
    boruta_selector = boruta_tree.BorutaPy(rfcv, n_estimators='auto', verbose=2, random_state=0, max_iter=100, perc = 50)
